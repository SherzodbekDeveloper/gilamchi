    ...
    <section className='py-15  scroll-mt-24'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className="text-start mb-16 flex flex-col gap-6">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 " data-aos="fade-up">Foydalanish Shartlari</h2>
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Xizmatlardan Foydalanish</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Intellektual Mulk</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Mas’uliyatni Cheklash</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">O&apos;zgartirishlar</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
