    ...
    <section className='py-15  scroll-mt-24'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className="text-start mb-16 flex flex-col gap-6">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 " data-aos="fade-up">Maxfiylik siyosati</h2>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Ma&apos;lumotlarni yig&apos;ish va ulardan foydalanish</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Ma&apos;lumotlaringizni himoya qilish</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Ma&apos;lumotlarni uchinchi tomonlarga oshkor qilish</h3>
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Cookies va kuzatish texnologiyalari</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Ma&apos;lumotlarni saqlash</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Foydalanuvchilar huquqlari</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Maxfiylik siyosatiga o&apos;zgarishlar</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
          ...
          <h3 className="text-xl md:text-xl lg:text-2xl font-bold text-gray-900 " data-aos="fade-up">Biz bilan bog&apos;laning</h3>
          <p className="text-lg md:text-xl text-gray-600 " data-aos="fade-up">
            Maxfiylik siyosati bo&apos;yicha savollaringiz bo&apos;lsa, quyidagi manzillar orqali biz bilan bog&apos;lanishingiz mumkin:
          </p>
          <div className='flex flex-col text-lg ' data-aos="fade-up">
