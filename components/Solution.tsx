      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div>
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4" data-aos="fade-up">  Biz Taklif Etadigan Yechimlar</h2>
        ...
        <div className=' items-start flex flex-col lg:flex-row justify-between gap-4 ' >
          <div className='lg:max-w-xl w-full lg:order-1 order-2'>
            ...
            <div className='flex flex-col gap-6 mt-5 '>
              {Solutions.map((item) => (
                <div key={item.id} className='flex items-center gap-3' data-aos="fade-up" >
